...
Map("n", "M", "%")
Map({"n", "v", "c", "t"}, ";", function() vim.api.nvim_feedkeys(":", "n", false) end)
Map({"n", "v", "c", "t"}, ":", function() vim.api.nvim_feedkeys(";", "n", false) end)
...
Map("n", "gs", function() Snacks.picker.lsp_symbols() end, { desc = "Go to context head" })
...
Map("n", "<leader>ss", function() require("sidekick.cli").select() end, { desc = "Send This" })
