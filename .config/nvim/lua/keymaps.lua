...
Map("n", "gI", function() Snacks.picker.lsp_implementations({ include_current = true, auto_confirm = false }) util.esc() end, { desc = "Implementations list" })
...
Map("n", "<leader>ss", function() require("sidekick.cli").select({ filter = { installed = true} }) end, { desc = "Send This" })
Map({ "n", "t", "i", "x" }, "<C-.>", function() require("sidekick.cli").toggle() end, { desc = "Sidekick Toggle" })
Map({ "x", "n" }, "<leader>st", function() require("sidekick.cli").send({ msg = "{this}" }) end, { desc = "Send This" })
Map("n", "<leader>sf", function() require("sidekick.cli").send({ msg = "{file}" }) end, { desc = "Send File" })
Map("x", "<leader>sv", function() require("sidekick.cli").send({ msg = "{selection}" }) end, { desc = "Send Visual Selection" })
